...
!function($) {
    ...
    CalendarApp.prototype.onDrop = function (eventObj, date) { 
        var $this = this;
            ...
            var $categoryClass = eventObj.attr('data-bs-class');
    ...
    CalendarApp.prototype.init = function() {
        ...
        this.$saveCategoryBtn.on('click', function(){
            ...
            if (categoryName !== null && categoryName.length != 0) {
                $this.$extEvents.append('<div class="calendar-events" data-bs-class="bg-' + categoryColor + '" style="position: relative;"><i class="fa fa-circle text-' + categoryColor + '"></i>' + categoryName + '</div>')
                $this.enableDrag();
            }
